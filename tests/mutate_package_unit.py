...
MUTATIONS: list[tuple[str, Path, str, str, list[str]]] = [
    ...
    (
        "report: retained workbook rows copied wholesale, so unknown nested fields ship",
        MECHANISM,
    ...
    (
        "report: retained definition_of_done rows copied wholesale",
        MECHANISM,
        '"definition_of_done": {"applicable": KEEP, "workbooks": Rows(REPORT_DOD_ROW)},',
        '"definition_of_done": KEEP,',
        ["test_the_definition_of_done_is_scoped_and_loses_the_estates_own_verdict"],
    ),
    (
