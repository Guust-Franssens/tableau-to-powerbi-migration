...
Every example is a public Tableau Public workbook by its original author; each entry links back to the source it was migrated from. Full provenance for all 16 migrations is in [`reference-inventory.md`](reference-inventory.md).
