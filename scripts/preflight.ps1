...
Add-Cli 'dotnet' 'critical' 'Install the .NET SDK - needed to build/run the TMDL oracle (tools/tmdl_oracle) that check_datamodel.py uses. The per-example tmdl_validate helpers were retired and consolidated onto tools/tmdl_oracle (issue #413); this dependency is unchanged by that, since the oracle needs it too.'
