...
.EXAMPLE
    powershell -ExecutionPolicy Bypass -File scripts/update_migration_skills.ps1

.EXAMPLE
    powershell -ExecutionPolicy Bypass -File scripts/update_migration_skills.ps1 -Force
#>
[CmdletBinding()]
param(
    [switch]$Force,
